...
global.import = { meta: { env: { PUBLIC_SUPABASE_URL: 'dummy', PUBLIC_SUPABASE_ANON_KEY: 'dummy' } } } as any;

import { validateTwilioSignature } from './src/lib/twilio';
...
async function testSignature() {
    ...
    // Manual calculation to match lib logic
